...
Ported from watermarks-remover (MIT). Evaluates text for high-frequency AI
cadence markers, sentence-length burstiness variance, lexical diversity
(MATTR), and structural uniformity. Stdlib-only, no PyTorch or external
model dependencies.
"""
